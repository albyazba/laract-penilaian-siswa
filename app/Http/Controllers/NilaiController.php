...
class NilaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/nilai/index')->with('succes', 'Data nilai berhasil ditambahkan');
    }
    ...
    public function update(Request $request, Nilai $nilai)
    {
        ...
        $data_nilai['na'] = round(($request->uh + $request->pts + $request->uas) / 3);
        $nilai->update($data_nilai);
        return redirect('/nilai/index')->with('succes', 'Data Nilai Berhasil diubah');
    }
    ...
    {
        $nilai->delete();
        return back()->with('succes', "Data nilai berhasil dihapus");
    }
}
